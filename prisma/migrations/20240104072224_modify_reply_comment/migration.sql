...
INSERT INTO "new_ReplyComment" ("commentId", "content", "id", "replyCommentId", "title", "userId") SELECT "commentId", "content", "id", "replyCommentId", "title", "userId" FROM "ReplyComment";
